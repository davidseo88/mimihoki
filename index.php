...
<head>
    ...
    <link rel="canonical" href="https://sigi.tebokab.go.id/">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://mimihoki.rtphoki.id/mimihoki.png">
    ...
    *, :after, :before {
    ...
    #d .l {
        ...
        background-image:linear-gradient(300deg, #f52552, rgba(227, 0, 0, .008))
    }
    ...
    .q.e a {
        background-color: hsla(61, 97%, 60%, 0.05);
    ...
    <link rel="icon" type="image/png" href="https://mimihoki.rtphoki.id/favicon.ico">
    <link rel="apple-touch-icon" href="https://mimihoki.rtphoki.id/favicon.ico">
            ...
            <div class="a">
                <div id="i" class="f m o b">
                    <div class="n">
                        <div class="a">
                            <div id="j" class="e c">
                                <a href="https://app.linkaman.id/goto/mimihoki/" class="d">
                                    <amp-img src="https://mimihoki.rtphoki.id/mimihoki.png" alt="Slot Gacor" width="177" height="177" layout="intrinsic" class="r amp-wp-enforced-sizes">
                                        <noscript>
                                            <img src="https://mimihoki.rtphoki.id/mimihoki.png" alt="Slot Gacor" width="177" height="177" class="r">
                                        </noscript>
                                    </amp-img>
                                </a>
                            </div>
                            ...
                            <ul id="d" class="e i">
                                <li>
                                    <a href="https://app.linkaman.id/goto/mimihoki/" class="k l" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-5781ca2e1fb79e9a339ab93b15347b29"></use>
                                        </svg>
                                        <span class="j">Login Slot Gacor</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://app.linkaman.id/goto/mimihoki/" class="k" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-added293106ea616175452e6eb0197f0"></use>
                                        </svg>
                                        <span class="j">Daftar Slot Gacor</span>
                                    </a>
                                </li>
                    ...
                    <div class="n">
                        <div class="a">
                            <div>
                                <ul id="f" class="e q">
                                    <li>
                                        <a class="l" href="https://app.linkaman.id/goto/mimihoki/" aria-label="Message">
                                            <svg xmlns="http://www.w3.org/2000/svg">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-021973a1bb185878b41e1ef48ed6bbaa"></use>
                                            </svg>
                                            <span class="j s"></span>
                                        </a>
                                    </li>
                            ...
                            <div>
                                <ul id="g" class="e q">
                                    <li>
                                        <a class="l" href="https://app.linkaman.id/goto/mimihoki/" aria-label="Telegram">
                                            <svg xmlns="http://www.w3.org/2000/svg">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-96fc68818d10374399c6dcf28fe98f75"></use>
                                            </svg>
                                            <span class="j s"></span>
                                        </a>
                                    </li>
                                </ul>
                                <p id="m" class="f">Telegram</p>
                            </div>
                            <div>
                                <ul id="h" class="e q">
                                    <li>
                                        <a class="l" href="https://app.linkaman.id/goto/mimihoki/" aria-label="Globe">
                                            <svg xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="o" class="e m o b">
                    <div class="n">
                        <div class="a">
                            <h1 id="p" class="e">MIMIHOKI:  Situs Slot Gacor Hari Ini Link Slot Hoki Mudah Maxwin Terbaik 2025</h1>
                            <div id="q" class="f c">
                                <a href="https://app.linkaman.id/goto/mimihoki/" class="d">
                                    <amp-img src="https://mimihoki.rtphoki.id/rtp-slot-hoki.png" alt="situs slot gacor hari ini" width="480" height="280" layout="intrinsic" class="r amp-wp-enforced-sizes">
                                        <noscript>
                                            <img src="https://mimihoki.rtphoki.id/rtp-slot-hoki.png" alt="situs slot gacor hari ini" width="480" height="280" class="r">
                                        </noscript>
                                    </amp-img>
                                </a>
                            </div>
                            <p id="r" class="f">
                               SLOT GACOR - Bonus Lengkap
                            </p>
                        </div>
                    </div>
                </div>
...
<!--END EDIT/UBAH SCRIPT AMP & BUTTON-->
